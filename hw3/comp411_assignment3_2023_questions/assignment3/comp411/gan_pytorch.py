...
def discriminator_loss(logits_real, logits_fake):
    ...
    discriminator_targets = torch.ones_like(logits_real)

    loss1 = bce_loss(logits_real, discriminator_targets.squeeze())

    generator_targets = torch.zeros_like(logits_fake)

    loss2 = bce_loss((1 - logits_fake), generator_targets.squeeze())
...
def generator_loss(logits_fake):
    ...
    disriminator_targets = torch.ones_like(logits_fake)

    loss = bce_loss(logits_fake, disriminator_targets.squeeze())
